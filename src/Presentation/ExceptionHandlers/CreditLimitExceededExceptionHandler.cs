...
public sealed class CreditLimitExceededExceptionHandler : IExceptionHandler
{
    ...
    {
        Type = nameof(CreditLimitExceededException),
        Title = "Credit Limit Exceeded"
    };

    public async ValueTask<bool> TryHandleAsync(HttpContext httpContext, Exception exception, CancellationToken cancellationToken)
    {
        if (exception is not CreditLimitExceededException)
        {
            return false;
        }
